            ...
            <img src="{{ asset('storage/'.$row->image_url) }}" class="h-80 w-72 object-cover rounded-t-xl hover:object-scale-down"/>
                <div class="px-4 py-3 w-72">
                    ...
                    <div class="justify-items-stretch">
                        <div class="text-sm font-semibold text-black cursor-auto my-1">Stock: <span class="text-sm text-gray-600 font-light cursor-auto ml-2 float-right">{{$row->stock_in}}</span></div>
